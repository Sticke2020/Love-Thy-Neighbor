            ...
            <div class="collapse navbar-collapse justify-content-center" id="mainNavbar">
                ...
                <ul class="navbar-nav gap-5">
                    ...
                    <li class="nav-item fs-4">
                        <a class="nav-link text-custom-white" href="admin_manager?action=home">Home</a>
                    </li>
                    ...
                    <li class="nav-item fs-4">
                        <a class="nav-link text-custom-white" href="admin_manager?action=search_users">Users</a>
                    </li>
