...
ALTER TABLE `message_user` ADD FOREIGN KEY (`message_id`) REFERENCES `message` (`id`);

ALTER TABLE `message_user` ADD FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
...
-- Insert message
INSERT INTO message (sender_id, receiver_id, body, date_created) VALUES
(4, 5, 'Hello Debbie, I am Ron the owner of Rons Automotive and I would love to replace your car tire for you', NOW()),
(5, 4, 'Hello Ron, Thank you for the offer I would appreciate that so much are you available on Tuesday?', NOW()),
(4, 5, 'Glad I can help, Yes I am available Tuesday, call the shop to schedule me for an onsite visit free of charge 715-123-4321', NOW()),
(7, 8, 'Hello Melissa, I am Samuel the owner of NR Plumbing, I would like to fix your burst water pipe, if you would like to accept my offer call 715-443-4342 and we can schedule a time that works for you', NOW());
...
-- Insert into outbox and inbox of message_user from message table
INSERT INTO message_user (message_id, user_id, folder, is_read, is_deleted)
SELECT id, sender_id, 'outbox', TRUE, FALSE FROM message;

INSERT INTO message_user (message_id, user_id, folder, is_read, is_deleted)
SELECT id, receiver_id, 'inbox', TRUE, FALSE FROM message;
